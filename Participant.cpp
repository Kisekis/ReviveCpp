...
vector<TransactionChannel> *Participant::generateTransactionChannels() {
...
vector<TransactionChannel> &Participant::rebalanceCore(vector<TransactionChannel> &channels, int m) {
    {
        glp_prob *lp;
        lp = glp_create_prob();
...
void Participant::print(vector<TransactionChannel> channels) {
    double unbalance = 0;
